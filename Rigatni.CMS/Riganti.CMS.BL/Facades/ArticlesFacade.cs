...
namespace Riganti.CMS.BL.Facades
{
    ...
    {
        public ArticlesFacade(Func<IQuery<ArticlesListDTO>> query, IRepository<Article, int> repository, IEntityDTOMapper<Article, ArticleDetailDTO> mapper) : base(query, repository, mapper)
        {
        }
